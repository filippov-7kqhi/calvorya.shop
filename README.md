...
A fully responsive baseball & softball coaching website built with plain HTML, CSS and JavaScript (no build step required).
...
- Hero, About, Programs, Field Schedule, Testimonials, Pricing, CTA, and Contact sections
